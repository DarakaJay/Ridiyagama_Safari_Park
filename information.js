document.getElementById('faqBtn').addEventListener('click', function() {
    var faqDetails = document.getElementById('faqDetails');
    faqDetails.style.display = faqDetails.style.display === 'block' ? 'none' : 'block';
  });
  
  document.getElementById('parkBtn').addEventListener('click', function() {
    var parkDetails = document.getElementById('parkDetails');
    parkDetails.style.display = parkDetails.style.display === 'block' ? 'none' : 'block';
  });
